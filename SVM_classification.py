...
param_grid = {
    'C': [0.01,0.001,0.009,0.9,0.5, 0.1, 1,1.2, 1.5, 2],
    'penalty': ['l1', 'l2']
}
...
optim_SVM = SVC(C=best_params['C'],  kernel='linear',  probability=True,max_iter=10000, class_weight=class_weights, random_state=82)


optim_SVM.fit(X, y)
y_pred = optim_SVM.predict(X_test)
y_prob = optim_SVM.predict_proba(X_test)[:, 1]
